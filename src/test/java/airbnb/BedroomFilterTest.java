...
public class BedroomFilterTest {

    private Filter filter;

    @BeforeEach
    void setUp() {
        filter = new BedroomFilter();
    }

    @Test
    public void shouldGetCorrectNumberOfBedrooms() {
        var html = """
<div data-plugin-in-point-id="OVERVIEW_DEFAULT" data-section-id="OVERVIEW_DEFAULT" style="padding-top: 48px; padding-bottom: 24px;">
	<section>
        ...
        var expected = new Attribute("bedrooms", "1 bedroom");
    ...
    @Test
    public void shouldReturnEmptyOptionalIfListDoesNotContainBedrooms() {
        var html = """
                <div data-plugin-in-point-id="OVERVIEW_DEFAULT" data-section-id="OVERVIEW_DEFAULT" style="padding-top: 48px; padding-bottom: 24px;">
                	<section>
                		<div>
